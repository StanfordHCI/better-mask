...
const { getSymbolAndDecimals } = require('lib/token-util')
...
PendingTx.prototype.render = function () {
  ...
  if (isFetching) {
    return h(Loading, {
      loadingMessage: this.context && this.context.t ? this.context.t('generatingTransaction') : "Generating transaction...",
    })
  }
