import getBackground from 'data/backgroundConnection';
...
function ConfirmTxScreen () {
  ...
  actions._setBackgroundConnection(getBackground());
}
...
ConfirmTxScreen.prototype.getTxData = function () {
  ...
  if (transactionId) {
    return R.find(({ id }) => id + '' === transactionId)(unconfTxList)
  }

  throw new Error("Didn't work as expected :'(");
...
ConfirmTxScreen.prototype.getChildContext = function () {
  // TODO return the actual translation message instead of the key
  // TODO translation provider using the new context API
  return {
    t: (key) => {
      return key;
    }
...
ConfirmTxScreen.childContextTypes = {
  t: PropTypes.func,
}