...
const getBuyEthUrl = require('metamask-crx/app/scripts/lib/buy-eth-url')
const { getTokenAddressFromTokenObject } = require('lib/util')
const {
  calcGasTotal,
  calcTokenBalance,
  estimateGas,
...
const { fetchLocale } = () => {
  throw new Error('you should definitely not be using this. actions.js is there only for the confirm transactions screen');
}
