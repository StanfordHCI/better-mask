...
import {PROFILE_ROUTE, DEFAULT_ROUTE, ASSETS_ROUTE, REFERRALS_ROUTE} from 'routes';
import {lockAccount} from 'data/auth';

import FlatLink from 'components/FlatLink';

import { mainMenu, recentApps } from './sideMenu';
...
const hoc = compose(
  ...
  connect((state) => ({
    authenticated: state.metamask.isUnlocked,
    lockingAccount: state.auth.lockingAccount,
  }), (dispatch) => ({
